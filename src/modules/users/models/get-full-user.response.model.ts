...
export class GetFullUserResponseModel {
    ...
    public readonly socksUsername: string;
    public readonly socksPassword: string;
    ...
    constructor(entity: UserEntity, subPublicDomain: string) {
        ...
        this.socksUsername = entity.socksUsername;
        this.socksPassword = entity.socksPassword;
